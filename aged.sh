...
function displayHelp(){
    echo "Usage: aged [OPTION] [FILE/MESSAGE]";
    echo "   uses the age encryption tool to excrypt/decrypt files/messages using";
    echo "   github associated private & public ssh keys for sender and recipient respectively.";
    echo " ";
    echo "  OPTIONS:";
    echo "    -i, --init      initialises aged.conf with default github username eg -i [USERNAME] ";
